function simulateHTML5DragAndDrop(sourceFrameID, targetFrameID,sourceXPath,targetXpath) {

	try{
		var doc=document.getElementById(sourceFrameID).contentDocument;
		var doc1=document.getElementById(targetFrameID).contentDocument;

		var sourceElement=doc.evaluate(sourceXPath, doc, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
		var targetElement=doc1.evaluate(targetXpath, doc1, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
    ...
    DndSimulator.simulate(sourceElement, targetElement);
